...
def construct_model(model, num_classes=10, seed=None, num_channels=3, modelkey=None):
    ...
    if model in ['ConvNet', 'ConvNet64']:
        ...
        model = ResNet(torchvision.models.resnet.BasicBlock, [3, 3, 3], num_classes=num_classes, base_width=238)
    ...
    elif model == 'ResNet18-mini':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=32)   # base = 32
    elif model == 'ResNet18':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=64)
    elif model == 'ResNet18-2':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=64 * 2)
    elif model == 'ResNet18-3':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=64 * 3)
    elif model == 'ResNet18-4':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=64 * 4)
    elif model == 'ResNet18-5':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=64 * 5)
    elif model == 'ResNet18-247':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=247)
    elif model == 'ResNet18-225':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=225)
    elif model == 'ResNet18-160':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=160)
    elif model == 'ResNet18-230':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=230)
    elif model == 'ResNet18-238':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=238)
    elif model == 'ResNet18-251':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=251)
    elif model == 'ResNet18-210':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=210)
    elif model == 'ResNet18-274':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=274)
    elif model == 'ResNet18-292':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=292)
    elif model == 'ResNet18-310':
        model = ResNet(torchvision.models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_classes, base_width=310)
    elif model == 'ResNet34':
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        for m in self.modules():
            if isinstance(m, nn.Conv2d):
                # nn.init.kaiming_normal_(m.weight, mode='fan_out', nonlinearity='relu') #oringal 用一个正态分布生成值进行填充
                # nn.init.kaiming_uniform_(m.weight, mode='fan_out', nonlinearity='relu')  # 均匀分布
                # nn.init.xavier_normal_(m.weight, gain=1.1415)  # gain=math.sqrt(2.0)

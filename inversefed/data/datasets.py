...
class FFHQFolder(ImageFolder):
    def __init__(self, root, transform=None, target_transform=None):
        # self.root = '/home/qian/project/gradient-inversion-main/Dataset'
        assert os.path.exists(root), "path '{}' not exist".format(root)
    ...
    def __getitem__(self, index):
        ...
        self.root = "/home/qian/project/gradient-inversion-main/Dataset"  # 使其能够找到与FFHQ同级目录的json文件
